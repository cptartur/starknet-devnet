...
@require_valid_request_and_response("getTransactionByHash")
...
@require_valid_request_and_response("getTransactionByBlockIdAndIndex")
...
@require_valid_request_and_response("getTransactionReceipt")
...
@require_valid_request_and_response("pendingTransactions")
...
@require_valid_request_and_response("addInvokeTransaction")
...
@require_valid_request_and_response("addDeclareTransaction")
...
@require_valid_request_and_response("addDeployTransaction")
...
@require_valid_request_and_response("addDeployAccountTransaction")
...
@require_valid_request_and_response("estimateFee")
