...
@require_valid_response("getBlockWithTxHashes")
...
@require_valid_response("getBlockWithTxs")
...
@require_valid_response("blockNumber")
...
@require_valid_response("blockHashAndNumber")
...
@require_valid_response("getBlockTransactionCount")
