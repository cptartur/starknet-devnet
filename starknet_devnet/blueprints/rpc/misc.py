...
@require_valid_request_and_response("chainId")
...
@require_valid_request_and_response("syncing")
...
@require_valid_request_and_response("getEvents")
...
@require_valid_request_and_response("getNonce")
